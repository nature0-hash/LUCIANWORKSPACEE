...
// Code Converter) as a single module rendered inside the LUCIAN shell's
// main content area. The module keeps its own internal Zustand store for
// project state but DOES NOT have its own theme system — it reuses
// LUCIAN's global ThemeProvider (useTheme) for visual theming.
